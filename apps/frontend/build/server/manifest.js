...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-Lk5vr6aj.js')),
			__memo(() => import('./chunks/1-BrZFgnTq.js')),
			__memo(() => import('./chunks/2-B1o7GM7f.js')),
			__memo(() => import('./chunks/3-BgIWA0fJ.js')),
			__memo(() => import('./chunks/4-BLsGyLil.js')),
			__memo(() => import('./chunks/5-DL3pLxCt.js')),
			__memo(() => import('./chunks/6-Bmj5Xx3x.js')),
			__memo(() => import('./chunks/7-BJfyKo28.js')),
			__memo(() => import('./chunks/8-mBKdTF4m.js')),
			__memo(() => import('./chunks/9-DUcmYpK2.js')),
			__memo(() => import('./chunks/10-Deqsvby7.js')),
			__memo(() => import('./chunks/11-GEcUodil.js')),
			__memo(() => import('./chunks/12-DQLk6M5o.js')),
			__memo(() => import('./chunks/13-D4fyY-WN.js')),
			__memo(() => import('./chunks/14-CRimPef7.js')),
			__memo(() => import('./chunks/15-CorcfwKt.js')),
			__memo(() => import('./chunks/16-DftzdFgS.js')),
			__memo(() => import('./chunks/17-CEjzxERy.js'))
		],
		remotes: {
