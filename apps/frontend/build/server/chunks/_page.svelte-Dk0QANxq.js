...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { data, form } = $$props;
    $$renderer2.push(`<div class="page svelte-1huw90i">`);
    AppHeader($$renderer2, {
    ...
    $$renderer2.push(`<!--]--></select></div> <div class="input-group svelte-1huw90i"><label for="child-medicalCondition" class="svelte-1huw90i">Medical Condition</label> <textarea id="child-medicalCondition" name="medicalCondition" rows="2" required="" class="svelte-1huw90i"></textarea></div> <button type="submit" class="submit-btn svelte-1huw90i">Create Child</button> `);
...
//# sourceMappingURL=_page.svelte-Dk0QANxq.js.map
