...
const index = 5;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-DwbXMz7H.js')).default;
...
const stylesheets = ["_app/immutable/assets/5.BLvwlgNI.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server as server, server_id, stylesheets };
//# sourceMappingURL=5-CEW3aA_t.js.map
