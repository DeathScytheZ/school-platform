...
<div class="dashboard">
            ...
            <section class="panel">
                ...
                {#if data.child}
                    <article class="info-card">
                        <h3>{data.child.first_name} {data.child.last_name}</h3>
                        <dl>
                            <div>
                                <dt>Level</dt>
                                <dd>{data.child.level}</dd>
                            </div>
                            <div>
                                <dt>Medical Condition</dt>
                                <dd>{data.child.medicalCondition || 'None recorded'}</dd>
                            </div>
                        </dl>
                    </article>
                {:else}
                    <p class="empty-msg">No student profile found</p>
                {/if}
            </section>
                ...
                <div class="table-wrap">
                    <table>
                        ...
                        <tbody>
                            ...
                            {:else}
                                <tr>
                                    <td colspan="3" class="empty-cell">No grades yet</td>
                                </tr>
                            {/each}
                        </tbody>
                    </table>
    ...
    <AppFooter profile={data.profile} context="Student workspace" />
</div>
