...
export { server };
export const server_id = "src/views/staff-dashboard/announcements/+page.server.js";
...
export const stylesheets = ["_app/immutable/assets/AppFooter.BrdsvKeT.css","_app/immutable/assets/9.pA6ITgcn.css"];
export const fonts = [];
