...
export { server };
export const server_id = "src/views/system-admin-dashboard/registration-requests/+page.server.js";
...
export const stylesheets = ["_app/immutable/assets/AppFooter.BrdsvKeT.css","_app/immutable/assets/15.DIbay7pP.css"];
export const fonts = [];
