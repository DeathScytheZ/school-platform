...
export { server };
export const server_id = "src/views/system-admin-dashboard/announcements/+page.server.js";
...
export const stylesheets = ["_app/immutable/assets/AppFooter.BrdsvKeT.css","_app/immutable/assets/13.JIGhcCKM.css"];
export const fonts = [];
